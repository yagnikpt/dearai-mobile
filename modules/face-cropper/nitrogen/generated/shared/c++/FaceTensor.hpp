...
namespace margelo::nitro::camera::facecropper {
  ...
  /**
   * A struct which can be represented as a JavaScript object (FaceTensor).
   */
  struct FaceTensor final {
  public:
  ...
  public:
    FaceTensor() = default;
    explicit FaceTensor(double width, double height, std::shared_ptr<ArrayBuffer> data): width(width), height(height), data(data) {}

  public:
    friend bool operator==(const FaceTensor& lhs, const FaceTensor& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ FaceTensor <> JS FaceTensor (object)
  template <>
  struct JSIConverter<margelo::nitro::camera::facecropper::FaceTensor> final {
    static inline margelo::nitro::camera::facecropper::FaceTensor fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::camera::facecropper::FaceTensor(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::camera::facecropper::FaceTensor& arg) {
